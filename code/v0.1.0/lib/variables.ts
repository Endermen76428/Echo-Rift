...
// export const DefaultRaidTime = 36000 // 30 Minutos em ticks
export const DefaultRaidTime = 18000 // 15 Minutos em ticks

export const MinPortalFrameSize = {w: 3, h: 4} // Interno w 2 e h 3
export const MaxPortalFrameSize = {w: 14, h: 18} // Interno w 12 e h 16
export const MaxDoorSize = {w: 5, h: 7}

export const HoldItemTypes: { [key: string]: THoldTypes } = {
  // Memory Fragment
...
export const memoryDimensionIndex: { [key: string]: number } = {
  "echo_rift:forgotten_kingdom": 0
}

export const RiftRequestsListTier0: { [key: string]: IRiftRequestItem[] } = {
  "echo_rift:memory_forgotten_kingdom": [
...
export const RiftRequestItemsTranslate: { [key: string]: string } = { // Item Type Id > Item Translation
  // Forgotten Kingdom
...
export const RiftLevelNames: { [key: string]: string[] } = {
...
export const dimensionsByIndex: Dimension[] = Array.from({length: maxDimensions})
export const memoryScoreIndex: ScoreboardObjective[] = Array.from({length: maxDimensions})
...
interface IRiftRequestItem {
  item: string // Type Ids
  amount: [number, number] // Min e Max
}