...
export function generateRoomMiniboss(dimension: Dimension, exit: Vector3, dir: string): void {
  ...
  if(minibossRooms == undefined) return console.error("§cFaltando salas do nível:§r", currentLevel)
